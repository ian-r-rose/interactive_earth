...
template<typename T>
TridiagonalMatrixSolver<T>::TridiagonalMatrixSolver( const unsigned int n )
                            : size(n)
{
  //Allocate space
...
template<typename T>
TridiagonalMatrixSolver<T>::~TridiagonalMatrixSolver()
{
  delete[] upper_diag;
  delete[] diag;
  delete[] lower_diag;
...
template class TridiagonalMatrixSolver<std::complex<double> >;
template class TridiagonalMatrixSolver<double>;
